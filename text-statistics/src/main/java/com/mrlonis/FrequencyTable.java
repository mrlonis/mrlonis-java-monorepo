...
public class FrequencyTable extends HashMap<Character, Integer> {
     ...
     *
     * @param text The text string used to construct the table of character counts.
     */
    ...
    /**
     * Returns the count associated with the given character. In the case that there is no association of ch in the map,
     * return 0.
     *
     * @param ch The character for which the count will be returned from the Frequency Table.
