 ...
 * compression.
 *
 * <p>Once constructed, the book is used to decode single characters in the code. This is more efficient than looking up
 * the code in the Huffman tree each time it is needed.
 *
 * <p>A CodeBook creates a HuffmanTree as an artifact, and provides a getter to make the tree available.
 *
...
public class CodeBook {
    ...
    public CodeBook() {
        ...
        double[] probs = new double[] {
            11.602, 4.702, 3.511, 2.670, 2.007, 3.779, 1.950, 7.232, 6.286, 0.597, 0.590, 2.705, 4.383, 2.365, 6.264,
            2.545, 0.173, 1.653, 7.755, 16.671, 1.487, 0.649, 6.753, 0.017, 1.620, 0.034,
        };
     ...
     *
     * @param text The text to be used in creating this CodeBook. CodeBook will be optomized to the given text.
     */
    ...
    private void readCodeFromTree() {
        /**
         * For each Character and Count in the FrequencyTable, put the character and corresponding bit string code into
         * this CodeBook.
         */
     ...
     *
     * @param ch The character to return the bit string code of.
