...
public class Wire {
     ...
     * TODO
     *
     * <p>Returns the minimal distance separating the two endpoints of this wire. The result corresponds to the length
     * of the shortest connecting wire. This is also known of as the Manhattan Distance between two points on a grid.
     *
     * <p>Note: This might be a useful property of a wire to incorporate into a heuristic for laying out the wires.
     * That's up to you. Feel free to experiment with other properties to see how they work in practice.
     */
