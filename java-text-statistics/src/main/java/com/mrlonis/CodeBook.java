 ...
 * string so as to achieve maximal compression.
 * 
 * Once constructed, the book is used to decode single characters in the code.
 * This is more efficient than looking up the code in the Huffman tree each time
 * it is needed.
 * 
 * A CodeBook creates a HuffmanTree as an artifact, and provides a getter to
...
public class CodeBook {
	...
	/**
	 * Creates a CodeBook based on the probabilities of English letters. Source:
	 * Wikipedia.
	 */
	public CodeBook() {
		this.freqs = new FrequencyTable();
		String alpha = "abcdefghijklmnopqrstuvwxyz";
		double[] probs = new double[] { 11.602, 4.702, 3.511, 2.670, 2.007, 3.779, 1.950, 7.232, 6.286, 0.597, 0.590,
				2.705, 4.383, 2.365, 6.264, 2.545, 0.173, 1.653, 7.755, 16.671, 1.487, 0.649, 6.753, 0.017, 1.620,
				0.034, };
	 ...
	 * 
	 * @param text
	 *            The text to be used in creating this CodeBook. CodeBook will
	 *            be optomized to the given text.
	 */
	...
	/**
	 * Reads the code represented by the HuffmanTree and stores each association
	 * in the map.
	 */
	 ...
	 * 
	 * @return A measure of the effectiveness of this code, as a sum of
	 *         normalized char frequencies weighted by the length of their
	 *         encodings.
	 */
	...
	/**
	 * Returns the bit string encoding for the given character by looking up the
	 * character in the map. Important: do not search the HuffmanTree here!
	 * 
	 * @param ch
