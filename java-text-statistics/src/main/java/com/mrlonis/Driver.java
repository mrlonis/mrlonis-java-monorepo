 ...
 * 
 * Once your code passes all the unit tests, replace text with the contents of
 * Alice In Wonderland. Figure out how to calculate the percentage of bits
 * saved. Do the same for Moby Dick. Then, download the plain text version of a
 * favorite book from http://www.gutenberg.org to your project directory, and
 * collect those statistics.
 * 
 * Create a text file named report.txt in your project directory. This file
 * should include your full name, username, and lab section, and a table of your
...
public class Driver {
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println("The number of bits saved is " + (text.length() * Constants.BITESIZE - bits.length()) + " bits.");
