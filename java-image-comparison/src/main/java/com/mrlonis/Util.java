...
public class Util {
     ...
     */
    public static double cosineSimilarity(ColorTable A,
                                          ColorTable B) {
     ...
     */
    public static double dotProduct(ColorTable A,
                                    ColorTable B) {
        double result = 0.0;
    ...
    /**
     * Returns true iff n is a prime number. We handles several common cases quickly, and then use a variation of the Sieve of Eratosthenes.
     */
    ...
    /**
     * The 3 components of a Color are packed into one 32-bit int. The result is used as a hash code for Colors in the ColorTable.
     * <p>
     * Each color component occupies exactly bitsPerChanel bits in the encoding.
     * <p>
     * The color components are shifted to the right to drop the lower order bits. Then the three reduced color components are packed into the lower order 3 * bitsPerChannel bits
     ...
     */
    public static Color unpack(int code,
                               int bitsPerChannel) {
