 ...
 * channel. Bits per channel can be anywhere from 1 to 8.
 *
 * @author mrlonis
 */
...
public class ColorIterator implements Iterator {
    ...
    /**
     * Returns the frequency count of the color specified by the r, g, and b values in colorTable. Increments the r, g,
     * and b values so the next time next() is called the r, g, and b values are incremented by inc.
     *
     * @return The frequency count associated with the color in colorTable specified by the r, g, and b variables
     */
    public long next() {
