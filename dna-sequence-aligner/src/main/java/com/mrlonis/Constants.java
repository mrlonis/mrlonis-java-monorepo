...
public class Constants {
    ...
    public static final Color MENU_COLOR = NUCLEOTIDE_COLOR;
    public static final int CELL_DIM = 55;
    public static final int MAX_CELLS = 32;
    public static final String SUITE_FILENAME = "suite.txt";
    public static final int SUITE_SIZE = 50;
