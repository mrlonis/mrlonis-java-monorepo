 ...
 * project.
 * <p>
 * The Sequence Aligner determines the bets possible alignment between two strings by filling in an array of Results
...
public class SequenceAligner {
     ...
     * <p>
     * Ordering convention: So that your code will identify the same alignment as is expected in Testing, we establish
     * the following preferred order of operations: M (diag), I (left), D (up). This only applies when you are picking
     * the operation with the biggest payoff and two or more operations have the same max score.
     */
     ...
     *
     * @param i
     *         The row in the cache to lookup in.
     * @param j
     *         The column in the cache to lookup in.
     *
