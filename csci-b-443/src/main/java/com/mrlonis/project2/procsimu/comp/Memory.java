...
import com.mrlonis.project2.procsimu.Configuration;
...
public class Memory extends Stage {
    ...
    private void initWindow(String title) {
        ...
        /*
         * This is deprecated. We need to use this.setVisible(true);
         */
        // this.show();
    ...
    public void write(long address, long value) {
        ...
        dataModel.setValueAt((long) values[(int) address], (int) address, 1);
        dataModel.setValueAt((long) values[(int) address + 1], (int) address + 1, 1);
        dataModel.setValueAt((long) values[(int) address + 2], (int) address + 2, 1);
        dataModel.setValueAt((long) values[(int) address + 3], (int) address + 3, 1);
