...
public class Const {
    ...
    public static final int MIPS_BNE = 5; // Page 78

    public static final int MIPS_J = 2;
    public static final int MIPS_ANDI = 12;

    // TODO add opcodes for ADDI, ORI, XORI
    public static final int MIPS_ADDI = 8; // Page 64
    public static final int MIPS_ORI = 13; // Page 78
    public static final int MIPS_XORI = 14; // Page 103

    // MIPS extended instructions
    public static final int EXT_AND = 36;
    // TODO add extended opcodes for ADD, SUB, OR, XOR, SLT, SLL, SRL
    public static final int EXT_ADD = 32; // Page 78
    public static final int EXT_SUB = 34; // Page 78
    public static final int EXT_OR = 37; // Page 78
    public static final int EXT_XOR = 38; // Page 103
    public static final int EXT_SLT = 42; // Page 78
    public static final int EXT_SLL = 0; // Page 78
    public static final int EXT_SRL = 2; // Page 78
