...
public class DefaultInputHandler extends InputHandler {
    ...
    /**
     * Adds a key binding to this input handler. The key binding is a list of white space separated key strokes of the
     * form <i>[modifiers+]key</i> where modifier is C for Control, A for Alt, or S for Shift, and key is either a
     * character (a-z) or a field name in the KeyEvent class prefixed with VK_ (e.g., BACK_SPACE)
     *
    ...
    /**
     * Returns a copy of this input handler that shares the same key bindings. Setting key bindings in the copy will
     * also set them in the original.
     */
        ...
        if ((modifiers & ~KeyEvent.SHIFT_MASK) != 0
            ...
            switch (o) {
                case null -> {
                    ...
                    com.mrlonis.mar45.mars.Globals.getGui().dispatchEventToMenu(evt);
                    evt.consume();
                    return;
                }
     ...
     * is either a single character, or a keycode name from the <code>KeyEvent</code> class, without the <code>VK_
     * </code> prefix.
     *
