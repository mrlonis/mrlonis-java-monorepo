package com.mrlonis.mar45.mars.venus.editors.jeditsyntax;

import com.mrlonis.mar45.mars.*;
import com.mrlonis.mar45.mars.venus.EditPane;
import com.mrlonis.mar45.mars.venus.editors.MARSTextEditingArea;
import com.mrlonis.mar45.mars.venus.editors.jeditsyntax.tokenmarker.*;
import java.awt.*;
import javax.swing.*;
 ...
 *
 * <p>Provides those methods required by the MARSTextEditingArea interface that are not defined by JEditTextArea. This
 * permits JEditTextArea to be used within MARS largely without modification. DPS 4-20-2010
 *
 * @since 4.0
...
public class JEditBasedTextArea extends JEditTextArea implements MARSTextEditingArea, CaretListener {
    ...
    /**
     * Returns next posn of word in text - forward search. If end of string is reached during the search, will wrap
     * around to the beginning one time.
     *
    ...
    public int doReplace(String find, String replace, boolean caseSensitive) {
        ...
        if (find == null
                || !find.equals(sourceCode.getSelectedText())
