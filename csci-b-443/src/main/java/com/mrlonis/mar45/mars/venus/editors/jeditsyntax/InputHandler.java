 ...
 * action repetition.
 *
 * <p>This class provides all the necessary support code for an input handler, but doesn't actually do any key binding
 ...
 *     <p>08/12/2002 Clipboard actions (Oliver Henning)
 */
public abstract class InputHandler extends KeyAdapter {
    ...
    /**
     * Adds the default key bindings to this input handler. This should not be called in the constructor of this input
     * handler, because applications might load the key bindings from a file, etc.
     */
