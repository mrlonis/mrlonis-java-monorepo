...
public class TextAreaPainter extends JComponent implements TabExpander {
     ...
     *
     * <p>NOTE: as of Java 1.4 this method is deprecated and no longer has the desired effect because the focus
     * subsystem does not call it. I've implemented a KeyEventDispatcher in JEditTextArea to handle Tabs. DPS
     * 12-May-2010
     */
    ...
    /**
     * Returns true if bracket highlighting is enabled, false otherwise. When bracket highlighting is enabled, the
    ...
    public interface Highlight {
        ...
        /**
         * Returns the tool tip to display at the specified location. If this highlighter doesn't know what to display,
         * it should delegate to the next highlight painter.
         *
    ...
    public String getToolTipText(MouseEvent evt) {
        ...
        else if (this.textArea.getTokenMarker() == null) return null;
        else return this.textArea.getSyntaxSensitiveToolTipText(evt.getX(), evt.getY());
    ...
    /**
     * Sets the font for this component. This is overridden to update the cached font metrics and to recalculate which
     * lines are visible.
     *
     * @param font The font
     */
    ...
    public void paint(Graphics gfx) {
        ...
        tabSize = fm.charWidth(' ') * tabSizeChars; // was:
    ...
    protected void paintLine(
            Graphics gfx, TokenMarker tokenMarker, int line, int x) { // System.out.println("paintLine "+ (++count));
    ...
    protected void paintSyntaxLine(
            ...
            Color defaultColor,
            int x,
            int y) { // System.out.println("paintSyntaxLine line "+ line);
    ...
    protected void paintLineHighlight(
            Graphics gfx, int line, int y) { // System.out.println("paintLineHighlight "+ (++count));
        int height = fm.getHeight();
        ...
        if (selectionStart == selectionEnd) {
            ...
            if (textArea.isSelectionRectangular()) {
                ...
                x1 = textArea._offsetToX(
                        line, Math.min(lineLen, selectionStart - textArea.getLineStartOffset(selectionStartLine)));
                x2 = textArea._offsetToX(
                        line, Math.min(lineLen, selectionEnd - textArea.getLineStartOffset(selectionEndLine)));
                if (x1 == x2) x2++;
