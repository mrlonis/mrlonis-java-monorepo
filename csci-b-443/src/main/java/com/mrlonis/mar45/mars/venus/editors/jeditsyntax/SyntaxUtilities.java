...
public class SyntaxUtilities {
    ...
    /**
     * Returns the default style table. This can be passed to the <code>setStyles()</code> method of <code>
     * SyntaxDocument</code> to use the default syntax styles.
     */
    public static SyntaxStyle[] getDefaultSyntaxStyles() {
        ...
        styles[Token.LITERAL1] =
                new SyntaxStyle(new Color(0x00CC33), false, false); // (new Color(0x650099),false,false);
        styles[Token.LITERAL2] =
                new SyntaxStyle(new Color(0x00CC33), false, false); // (new Color(0x650099),false,true);
    ...
    /**
     * Returns the CURRENT style table. This can be passed to the <code>setStyles()</code> method of <code>
     * SyntaxDocument</code> to use the current syntax styles. If changes have been made via MARS Settings menu, the
    ...
    public static int paintSyntaxLine(
        ...
        for (; ; ) {
            ...
            if (id == Token.KEYWORD1) {
                ...
                //	   new MouseEvent((Component)expander, MouseEvent.MOUSE_MOVED, new java.util.Date().getTime(), 0, x,
                // y, 0, false));
