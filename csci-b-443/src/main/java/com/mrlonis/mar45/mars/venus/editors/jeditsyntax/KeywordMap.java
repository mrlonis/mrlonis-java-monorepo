...
/**
 * A <code>KeywordMap</code> is similar to a hashtable in that it maps keys to values. However, the `keys' are Swing
 * segments. This allows lookups of text substrings without the overhead of creating a new string object.
 *
 * <p>This class is used by <code>CTokenMarker</code> to map keywords to ids.
 *
...
public class KeywordMap {
     ...
     * @param mapLength The number of `buckets' to create. A value of 52 will give good performance for most maps.
     */
    ...
    public byte lookup(Segment text, int offset, int length) {
        ...
        if (text.array[offset] == '%') return Token.MACRO_ARG; // added 12/12 M. Sekhavat
