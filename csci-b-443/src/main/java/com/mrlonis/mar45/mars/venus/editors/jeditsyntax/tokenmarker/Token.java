 ...
 * up in the array returned by <code>SyntaxDocument.getColors()</code> to get a color value, a length value which is the
...
public class Token {
    ...
    /**
     * Keyword 2 token id. This can be used to mark a keyword. This should be used for preprocessor commands, or
     * variables.
     */
    ...
    /**
     * Invalid token id. This can be used to mark invalid or incomplete tokens, so the user can easily spot syntax
     * errors.
     */
