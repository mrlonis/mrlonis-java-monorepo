...
/**
 * This class implements a generic height-balanced binary search tree, using the AVL algorithm. Beyond the constructor,
 * only the insert() method needs to be implemented. All other methods are unchanged.
 *
